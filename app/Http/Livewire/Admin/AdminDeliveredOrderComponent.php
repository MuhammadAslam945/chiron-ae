...
use Carbon\Carbon;
class AdminDeliveredOrderComponent extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-delivered-order-component',['orders'=>$orders])->layout('layouts.admin.base');
    }
}
