...
use Carbon\Carbon;
class AdminOnwayOrderComponent extends Component
{
    use WithPagination;
    ...
    {
        $orders=Order::where('status','onway')->paginate(12);
        return view('livewire.admin.admin-onway-order-component', ['orders' => $orders])->layout('layouts.admin.base');
    }
}
