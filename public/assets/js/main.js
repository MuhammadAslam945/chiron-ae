        ...
        if (target.length > 0) {
            target.each(function () {
                var el = $(this),
                    ...
                    dataNavLeft = (el.data('owl-nav-left')) ? el.data('owl-nav-left') : "<i class='fa fa-arrow-left'></i>",
                    dataNavRight = (el.data('owl-nav-right')) ? el.data('owl-nav-right') : "<i class='fa fa-arrow-right'></i>",
